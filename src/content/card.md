...
| Part | Role |
|------|------|
| **Root** | Outer surface — spacing, border, background, and radius |
| **Header** | Top block for title, description, and optional action |
| **Title** | Primary label for the card's subject |
| **Description** | Supporting text below the title — often muted |
| **Action** | Header control (menu, icon button) |
| **Content** | Main body — text, media, forms, or charts |

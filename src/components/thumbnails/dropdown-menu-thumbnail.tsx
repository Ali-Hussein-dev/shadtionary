...
function DropdownMenuThumbnail({ className }: { className?: string }) {
	return (
		<div
			aria-hidden
		...
		>
			<div className="relative flex aspect-5/3 w-full items-center justify-center">
				<div className="w-[72%] max-w-44 space-y-1.5">
					<div className="flex w-fit items-center gap-1.5 rounded-md border bg-card px-2 py-1.5 shadow-sm">

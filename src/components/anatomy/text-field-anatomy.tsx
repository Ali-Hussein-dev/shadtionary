...
function TextFieldAnatomy() {
	return (
		<AnatomyContainer caption="Labeled diagram of text field parts: Field wrapper with FieldLabel above Input, FieldDescription helper text below, and FieldError for validation.">
			<AnatomySection>
				<div className="relative rounded-md border border-dashed border-primary/20 bg-secondary p-4 pt-8">
					...
					<div className="relative mt-2 space-y-2.5">
						...
						<div className="relative rounded-md border bg-card px-3 py-2 pt-7">
							<AnatomyLabel
								name="Input"
								className="absolute top-2 left-2.5 whitespace-nowrap"
							/>
							<ChromeBar tone="subtle" className="h-2.5 w-32" />
						</div>
